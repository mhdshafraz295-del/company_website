...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-16 sm:py-20 lg:py-24 bg-white dark:bg-[#030712] relative z-10 select-none">
            ...
            {services.map((service, idx) => {
              ...
              return (
                <Reveal3D key={service.id} delay={idx * 0.02}>
                  <TiltCard className="group bg-white/80 dark:bg-[#0D1322]/80 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 hover:border-cyan-400 dark:hover:border-cyan-500/50 shadow-xl shadow-slate-200/40 dark:shadow-slate-950/40 rounded-3xl p-6 sm:p-7 flex flex-col justify-between h-full hover:shadow-2xl hover:shadow-cyan-500/10">
                    <div className="space-y-4">
                      <div className="p-3.5 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 border border-cyan-100 dark:border-slate-700 rounded-2xl text-cyan-600 dark:text-cyan-400 w-fit shadow-sm">
                        <IconComponent className="w-6 h-6" />
                      </div>

                      <div className="space-y-2">
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors flex items-center justify-between">

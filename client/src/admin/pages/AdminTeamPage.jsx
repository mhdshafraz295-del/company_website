          ...
          <div className="bg-[#0b101d] border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-xl w-full space-y-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-1">
              ...
              <h2 className="text-xl font-extrabold text-white">
                {editingMember ? editingMember.name : 'Add Team Member'}
              </h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t border-slate-800">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-gradient-to-r from-violet-600 to-indigo-600 text-xs font-bold text-white rounded-xl shadow-lg transition flex items-center space-x-2"
                >

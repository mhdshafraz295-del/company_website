    ...
    <div className="space-y-6 animate-in fade-in duration-200 select-none">
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-[#0b101d] border border-slate-800 rounded-3xl w-full max-w-md max-h-[92dvh] flex flex-col shadow-2xl overflow-hidden">
            {/* Modal Sticky Header */}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-white">
                    {editingLink ? 'Edit Social Link' : 'Add Social Network'}
                  </h2>
                  <p className="text-[11px] text-slate-400">
                    Configure company channel links and footer badges.
                  </p>
                </div>
              </div>
              <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full bg-[#070b14] border border-slate-700/80 rounded-xl p-2.5 text-xs text-white focus:outline-none focus:border-cyan-500 font-mono"
                    />
                  </div>
